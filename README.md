...
| ----------------- | ----------------------------------------------------------------------------------------- |
| build [env|all]   | Runs `terraform init` and `terraform plan` on the specified environment or "all"          |
...
| release [env|all] | Runs `terraform apply` on the specified environment or "all"                              |
